                        ...
                        <div class="formulario_Izquierdo">
                            ...
                            <div class="formulario_derecho">
                                ...
                                <input type="number" name="stock" id="stock"  value="<?php echo $monstrar['stock']?>"readonly="true" disabled="true"/><br/>
                                    ...
                                    <div class="boton_generar_barcode">
                                        <button type="button" onclick="generarcodigobarras()">Codigo de Barras</button>
                                        <a href="http://localhost/proyecto_control_de_inventario/template/productos/generarCodigoDeBarra.php">Atrás</a>
                                    </div>
...
<script type="text/javascript" src="http://localhost/proyecto_control_de_inventario/assets/js/codigo.js"></script>
</body>
</html>
