...
<table class="table table table-striped table-dark table_id ">
    ...
    <tbody class="body_table">
        ...
        <tr>
            ...
            <td>
                <a href="php/actualizar2.php?id=<?php echo $monstrar['codigo']?>" class="boton_eliminar">
                    <i class="bi bi-pencil-square"></i>
                </a>
            </td>
            <td><a href="php/eliminar2.php?id=<?php echo $monstrar['codigo']?>" class="boton_eliminar"><i class="bi bi-trash3-fill"></i></a></td>
        </tr>
        <?php                                
        }                            
        ?>
